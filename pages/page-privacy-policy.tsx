                            ...
                            <div className="col-lg-9">
                                <div className="single-page pr-30">
                                    ...
                                    <div className="single-content">
                                        ...
                                        <ol start="1">
                                            <li>
                                                Hi there, we’re Evara Pty Ltd (ABN 11 119 159 741) of Level 1, 121 King Street Melbourne, 3000, Australia (“
                                                <strong>Evara</strong>”) and welcome to our privacy policy which also applies to our Affiliate Companies. This policy sets out how we handle your personal information if you’re an Evara user or visitor to our Sites. It applies across Evara Elements, Evara Market, Evara Twenty20, Evara Studio, Evara Sites, Evara Tuts+ and Placeit (the “<strong>Sites</strong>”).
                                            </li>
                                        ...
                                        <ol start="6">
                                            ...
                                            <li>
                                                ...
                                                our service provider Jumio Corporation located at 395 Page Mill Road, Suite 150, Palo Alto, California, USA. As part of Evara Verify, you will be asked to take a selfie which will then be compared against your Photo ID document using facial recognition technology. We will use your Photo ID document solely to carry out Evara Verify and delete it after the completion of this process.
                                            </li>
                                        </ol>
