          ...
          <div className="mobile-header-wrapper-inner">
              <div className="mobile-header-top">
                  <div className="mobile-header-logo">
                      <Link href="/index">
                          <a>
                              <Image src="/assets/imgs/theme/logo.svg" alt="logo" />
                          </a>
                      </Link>
                  </div>
              ...
              <div className="mobile-header-content-area">
                  ...
                  <div className="mobile-social-icon">
                      ...
                      <Link href="#">
                          <a>
                              <Image src="/assets/imgs/theme/icons/icon-facebook.svg" alt="" />
                          </a>
                      </Link>
                      <Link href="#">
                          <a>
                              <Image src="/assets/imgs/theme/icons/icon-twitter.svg" alt="" />
                          </a>
                      </Link>
                      <Link href="#">
                          <a>
                              <Image src="/assets/imgs/theme/icons/icon-instagram.svg" alt="" />
                          </a>
                      </Link>
                      <Link href="#">
                          <a>
                              <Image src="/assets/imgs/theme/icons/icon-pinterest.svg" alt="" />
                          </a>
                      </Link>
                      <Link href="#">
                          <a>
                              <Image src="/assets/imgs/theme/icons/icon-youtube.svg" alt="" />
                          </a>
                      </Link>
                  </div>
              </div>
