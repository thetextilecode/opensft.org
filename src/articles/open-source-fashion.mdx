...
don't know how to _be_ more sustainable.
...
where its source code is freely accessible to anyone who wishes to view it.
Open source software is usually, though not always, free in cost. The
software's accompanying license (usually just a file, much like [this one](https://github.com/microsoft/TypeScript/blob/main/LICENSE.txt))
determines what a user can and cannot do with the license, and this will
tend to vary.

There are many different types of open source software, and it's used in a
wide range of industries. For example, the Linux operating system is open
source, and so are the Android and Firefox browsers. Open source is also
used in a variety of business applications, such as the OpenOffice suite of
...
behind open source: transparency, participation, and collaboration. Open
source principals transcend software.
...
open source as a viable option, trailing behind other industries. It's
sometimes seems as something that smaller businesses do, but [this is quickly
changing](https://www.mckinsey.com/business-functions/mckinsey-digital/our-insights/open-source-e-commerce-the-next-wave-of-value-for-the-enterprise). There is a sort of unspoken secrecy in fashion, with
businesses and professionals alike tending to be more guarded about business
...
that 89% of companies use open source software. Any company that uses or
...
But in order to be more sustainable, we need to work together and share
...
things, because that's not where your competitive advantage lies.
