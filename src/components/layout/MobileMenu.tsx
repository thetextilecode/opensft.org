...
const MobileMenu = ({ menu, isToggled, toggleClick }: IMobileMenu) => {
        ...
        <div className="mobile-header-content-area">
          ...
          <div className="mobile-menu-wrap mobile-header-border">
            ...
            <nav>
              <ul className="mobile-menu" ref={domNode}>
                ...
                <li
                  className={
                    isActive.key == 1 ? 'menu-item-has-children active' : 'menu-item-has-children'
                  }
                >
                ...
                <li
                  className={
                    isActive.key == 2 ? 'menu-item-has-children active' : 'menu-item-has-children'
                  }
                >
                ...
                <li
                  className={
                    isActive.key == 4 ? 'menu-item-has-children active' : 'menu-item-has-children'
                  }
                >
                ...
                <li
                  className={
                    isActive.key == 5 ? 'menu-item-has-children active' : 'menu-item-has-children'
                  }
                >
                ...
                <li
                  className={
                    isActive.key == 6 ? 'menu-item-has-children active' : 'menu-item-has-children'
                  }
                >
          ...
          <div className="mobile-social-icon">
            ...
            <Link href="src/components/layout/MobileMenu#">
              <a>
                <Image
                  src="/assets/images/theme/icons/icon-youtube.svg"
                  alt="YouTube"
                  width={20}
                  height={20}
                />
