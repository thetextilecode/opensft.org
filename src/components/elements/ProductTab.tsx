            ...
            <div className="comments-area">
              <div className="row">
                    ...
                    <div className="single-comment justify-content-between d-flex">
                      <div className="user justify-content-between d-flex">
                        <div className="thumb text-center">
                          ...
                          <h6>
                            <a href="src/components/elements/ProductTab#">Jacky Chan</a>
                          </h6>
                        ...
                        <div className="desc">
                          ...
                          <div className="d-flex justify-content-between">
                            <div className="d-flex align-items-center">
                              ...
                              <a
                                href="src/components/elements/ProductTab#"
                    ...
                    <div className="single-comment justify-content-between d-flex">
                      <div className="user justify-content-between d-flex">
                        <div className="thumb text-center">
                          ...
                          <h6>
                            <a href="src/components/elements/ProductTab#">Ana Rosie</a>
                          </h6>
                    ...
                    <div className="single-comment justify-content-between d-flex">
                      <div className="user justify-content-between d-flex">
                        <div className="thumb text-center">
                          ...
                          <h6>
                            <a href="src/components/elements/ProductTab#">Steven Keny</a>
                          </h6>
                ...
                <div className="col-lg-4">
                  ...
                  <a href="src/components/elements/ProductTab#" className="font-xs text-muted">
              ...
              <div className="row">
                <div className="col-lg-8 col-md-12">
                  <form
                    ...
                    action="src/components/elements/ProductTab#"
                    id="commentForm"
                  >
                    <div className="row">
