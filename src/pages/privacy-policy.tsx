          ...
          <div className="row">
            <div className="single-page pr-30">
              ...
              <div className="single-content">
                ...
                <ol start={1}>
                  <li>
                    Hi there, we’re Open Source Fashion & Textiles CIC (Companies House number{' '}
                    {infoConfig.companiesHouseNumber}) of 71-75, Shelton Street, Covent Garden
                    London WC2H 9JQ (“<strong>Open Source Fashion & Textiles CIC</strong>”) and
                    welcome to our privacy policy which also applies to our Affiliate Companies.
                    This policy sets out how we handle your personal information if you’re an Open
                    Source Fashion & Textiles CIC user or visitor to our Sites. It applies across
                    Open Source Fashion & Textiles CIC (the “<strong>Sites</strong>”).
                  </li>
                  <li>
                    When we say ‘we’, ‘us’ or ‘Open Source Fashion & Textiles CIC’ it’s because
                    that’s who we are and we own and run the Sites.
                  </li>
                  <li>
                    If we say ‘policy’ we’re talking about this privacy policy. If we say ‘user
                    terms’ we’re talking about the rules for using each of the Sites. The rules vary
                    by product and each product makes them separately available and seeks consent to
                    them separately to this policy.
                  </li>
                </ol>
                    ...
                    <ol>
                      ...
                      <li>
                        ...
                        <ol>
                          ...
                          <li>
                            training Open Source Fashion & Textiles CIC staff about how to best
                      ...
                      <li>
                        For the purpose of responding to requests by government, a court of law, or
                ...
                <ol start={11}>
                  <li>
                    ...
                    <ol>
                      <li>
                        companies that are in the Open Source Fashion & Textiles CIC group which are
                        located in the UK;
                      </li>
                      <li>
                ...
                <ol start={12}>
                  <li>
                    We are based in the United Kingdom so your data will be processed in the UK.
                    Some of the recipients we have described in section 10 above, and to whom we
                    disclose your personal information, are based in places like Australia, Canada,
                    Ireland, Mexico, Philippines, Poland, Romania, UK, the US, India and Columbia.
                    We do this on the basis of this policy. In order to protect your information, we
                ...
                <ol start={13}>
                  <li>
                    ...
                    location in the UK. Personal information that we store or transmit is protected
                    by security and access controls, including username and password authentication,
                ...
                <ol start={14}>
                  <li>
                    ...
                    logging in to your account. You also have the right to make a request to access
                    other personal information we hold about you and to request corrections of any
                    errors in that data. You can also close the account you have with us for any of
                    our Sites at any time. To make an access or correction request, contact our
                    privacy champion using the contact details at the end of this policy.
                  </li>
                </ol>
                <h4>Marketing Choices regarding your personal information</h4>
                <ol start={15}>
                  <li>
                    Where we have your consent to do so (e.g. if you have subscribed to one of our
                    email lists or have indicated that you are interested in receiving offers or
                    information from us), we send you marketing communications by email about
                    products and services that we feel may be of interest to you. You can ‘opt-out’
                    of such communications if you would prefer not to receive them in the future by
                    using the “unsubscribe” facility provided in the communication itself.
                  </li>
                  <li>
                    You also have choices about cookies, as described below. By modifying your
                    browser preferences, you have the choice to accept all cookies, to be notified
                    when a cookie is set, or to reject all cookies. If you choose to reject cookies
                    some parts of our Sites may not work properly in your case.
                  </li>
                </ol>
                ...
                <ol start={17}>
                  ...
                  <li>
                    When you visit our Sites, there’s certain information that’s recorded which is
                    generally anonymous information and does not reveal your identity. If you’re
                    logged into your account some of this information could be associated with your
                    ...
                    <ol>
                      ...
                      <li>
                        the name of your internet service provider is sometimes captured depending
                  ...
                  <li>
                    Occasionally, we will use third party advertising companies to serve ads based
                    on prior visits to our Sites. For example, if you visit our Sites, you may later
                    see an add for our products and services when you visit a different Site. Read
                    more about your options in our
                ...
                <ol start={20}>
                  <li>
                    Our Sites are not suitable for children under the age of 16 years, so if you are
                    under 16 we ask that you do not use our Sites or give us your personal
                    information (if you are a young tech wiz, please direct your nearest responsible
                    adult to use the Sites for you!). If you are from 16 to 18 years, you can browse
                    the Sites but you’ll need the supervision of a parent or guardian to become a
                    registered user. It’s the responsibility of parents or guardians to monitor
                ...
                <ol start={21}>
                  <li>
                    ...
                    There are lots of ways that you can find yourself providing information to other
                    people, like when you post a public message on a forum thread, share information
                ...
                <ol start={22}>
                  <li>
                    ...
                    longer want us to use your personal information or to provide you with the Open
                    Source Fashion & Textiles CIC services, you can request that we erase your
                    personal information and close your Open Source Fashion & Textiles CIC account.
                    Please note that if you request the erasure of your personal information we will
                    retain information from deleted accounts as necessary for our legitimate
                    business interests, to comply with the law, prevent fraud, collect fees, resolve
                    disputes, troubleshoot problems, assist with investigations or requests by
                    government, a court of law, or law enforcement authorities, enforce the terms of
                    service and take other actions permitted by law. The information we retain will
                ...
                <ol start={23}>
                  ...
                  <li>
                    When we do change the policy, we’ll make sure to notify you about such changes,
                ...
                <ol start={25}>
                  ...
                  <li>
                    ...
                    this stuff is the best way to understand how your personal information is used
                    and how to best manage it!
                  </li>
                </ol>
                <h4>
                  If you’re a user or visitor in the European Economic Area these rights also apply
                  to you:
                </h4>
                <ol start={1}>
                  <li>
                ...
                <ol start={2}>
                  <li>
                    ...
                    transfer in a structured, commonly used and machine-readable format, to you), to
                    erase it, or restrict its processing. You also have rights to object to some
                  ...
                  <li>
                    These rights are limited in some situations – for example, we can demonstrate
                    that we have a legal requirement to process your personal information. In some
