...
const ProductsFullWidth = ({ newsletterUser, newsletterId, products, productFilters, fetchProduct }) => {
  ...
  return (
    <>
      <Layout parent='Home' sub='Shop' subChild='Filter' newsletterId={newsletterId} newsletterUser={newsletterUser}>
