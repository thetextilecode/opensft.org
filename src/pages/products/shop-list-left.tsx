...
const ProductsList = ({ newsletterUser, newsletterId, products, productFilters, fetchProduct }) => {
  ...
  return (
    <Layout parent='Home' sub='Shop' subChild='List' newsletterId={newsletterId} newsletterUser={newsletterUser}>
