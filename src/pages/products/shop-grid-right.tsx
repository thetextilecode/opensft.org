...
const Products = ({ newsletterUser, newsletterId, products, productFilters, fetchProduct }) => {
  ...
  return (
    <Layout parent='Home' sub='Shop' subChild='Grid' newsletterUser={newsletterUser} newsletterId={newsletterId}>
