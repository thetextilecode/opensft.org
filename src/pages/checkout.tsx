                ...
                <div className='form-group'>
                  <div className='checkbox'>
                    <div className='custome-checkbox'>
                      ...
                      <label className='form-check-label label_info' data-bs-toggle='collapse'
                             data-target='#collapsePassword' aria-controls='collapsePassword' htmlFor='createaccount'>
                ...
                <div className='payment_method'>
                  ...
                  <div className='payment_option'>
                    <div className='custome-radio'>
                      <input className='form-check-input' required={true} type='radio' name='payment_option'
                             id='exampleRadios3' checked={true} />
                      <label className='form-check-label' htmlFor='exampleRadios3' data-bs-toggle='collapse'
                             data-target='#bankTranfer' aria-controls='bankTranfer'>
                        Direct Bank Transfer
                      </label>
                      <div className='form-group collapse in' id='bankTranfer'>
                        <p className='text-muted mt-5'>There are many variations of passages of Lorem Ipsum available,
                          but the majority have suffered alteration. </p>
                      </div>
                    </div>
                    <div className='custome-radio'>
                      <input className='form-check-input' required={true} type='radio' name='payment_option'
                             id='exampleRadios4' checked={true} />
                      <label className='form-check-label' htmlFor='exampleRadios4' data-bs-toggle='collapse'
                             data-target='#checkPayment' aria-controls='checkPayment'>
                        Check Payment
                      </label>
                      <div className='form-group collapse in' id='checkPayment'>
                        <p className='text-muted mt-5'>Please send your cheque to Store Name, Store Street, Store
                          Town, Store State / County, Store Postcode. </p>
                      </div>
                    </div>
                    <div className='custome-radio'>
                      <input className='form-check-input' required={true} type='radio' name='payment_option'
                             id='exampleRadios5' checked={true} />
                      <label className='form-check-label' htmlFor='exampleRadios5' data-bs-toggle='collapse'
                             data-target='#paypal' aria-controls='paypal'>
                        Paypal
                      </label>
                      <div className='form-group collapse in' id='paypal'>
                        <p className='text-muted mt-5'>Pay via PayPal; you can pay with your credit card if you don't
