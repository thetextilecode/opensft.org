...
function Terms({ config, newsletterId, newsletterUser }) {
  return (
    <Layout
      parent="Home"
      sub="Terms"
              ...
              <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                ...
                <div className="single-content">
                  <p>
                    ...
                    before using the https://opensft.org website (the “Service”) operated by Open
                  ...
                  <ol>
                    ...
                    <li>
                      Members are granted a time-limited, non-exclusive, revocable, nontransferable,
                    ...
                    <li>
                      ...
                      which will be a minimum of one year after Member’s purchase.
                    </li>
                    <li>
                  ...
                  <p>
                    ...
                    owned or controlled by Open Source Fashion & Textiles CIC.
                  </p>
                  <p>
                    Open Source Fashion & Textiles CIC has no control over, and assumes no
                    responsibility for, the content, privacy policies, or practices of any third
                    party web sites or services. You further acknowledge and agree that Open Source
                    Fashion & Textiles CIC shall not be responsible or liable, directly or
                  ...
                  <h4>Governing Law</h4>
                  <p>
                    These Terms shall be governed and construed in accordance with the laws of Viet
                    Nam, without regard to its conflict of law provisions.
                  </p>
                  <p>
