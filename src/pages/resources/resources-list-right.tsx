...
import SingleResourceList from '../../components/resources/SingleResourceList';
...
const ResourcesList = ({
  ...
  let [pages, setPages] = useState<number>(Math.ceil(resources.items.length / limit));
...
export default connect(mapStateToProps, mapDidpatchToProps)(ResourcesList);
