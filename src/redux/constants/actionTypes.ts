...
export const FETCHED_RESOURCE = 'FETCHED_RESOURCE';
export const FETCHED_MORE_RESOURCE = 'FETCHED_MORE_RESOURCE';
...
export const UPDATE_RESOURCE_FILTERS = 'UPDATE_RESOURCE_FILTERS';
